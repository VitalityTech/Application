...
- The auth pages include Telegram fallbacks for both mobile platforms: Android opens Chrome via `intent://`, iOS opens Safari via `x-safari-https://...`, and a copy-link action is available as backup.
