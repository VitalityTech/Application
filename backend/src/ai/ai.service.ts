  ...
  async askQuestion(userId: string, question: string): Promise<string> {
    ...
    try {
      ...
      const systemPrompt = `
        ...
        3. Будь лаконічним і привітним. Використовуй емодзі.
        4. Якщо подій немає, напиши: "На цей період у тебе немає запланованих подій. Можливо, час щось створити? 😉"
      `;
      ...
      const chatCompletion = await this.groq.chat.completions.create({
        ...
        // ОНОВЛЕНО: використовуємо актуальну модель
